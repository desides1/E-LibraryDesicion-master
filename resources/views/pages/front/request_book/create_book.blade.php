...
@section('content_fe')
    <div class="container-fluid pb-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <button class="btn btn-danger" onclick="window.location.href = '{{ url('/front-request') }}';">
                Kembali</button>
            <form id="formSuggestion" enctype="multipart/form-data" class="p-2 mt-3">
                <div>
                    ...
                    <div class="mb-3 mt-4 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="staticEmail" value="{{ old('name') }}"
                                name="name" autofocus placeholder="Masukkan Nama Lengkap Anda"
                                oninput="(() => { restrictInputName(this); })()" required>
                        </div>
                    </div>
                    <div class="mb-3 mt-3 row">
                        ...
                        <div class="col-sm-9 d-flex">
                            ...
                            <div class="form-check me-3">
                                <input class="form-check-input" type="radio" name="status" id="Mahasiswa"
                                    value="Mahasiswa" {{ old('status' == 'Mahasiswa' ? 'checked' : '') }}>
                                <label class="form-check-label" for="Mahasiswa">
                                    Mahasiswa
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="Karyawan"
                                    value="Karyawan" {{ old('status' == 'Karyawan' ? 'checked' : '') }}>
                ...
                <div class="mt-4">
                    ...
                    <div class="mb-3 mt-4 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="authorBook" value="{{ old('author') }}"
                                name="author" required oninput="(() => { restrictInputName(this); })()">
                        </div>
                    </div>
                    <div class="mb-3 mt-4 row">
                    ...
                    <div class="mb-3 mt-4 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="stockBook"
                ...
                <div class="float-end my-3">
                    <button type="button" class="btn btn-danger"
                        onclick="window.location.href = '{{ url('/front-request') }}';"
                        style="border-radius: 5px;">Batal</button>
                    <button type="submit" class="btn btn-primary ms-2" style="border-radius: 5px;">Kirim Usulan
                        Buku</button>
                </div>
            </form>
        </div>
