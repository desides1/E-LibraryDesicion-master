...
@section('content_fe')
        ...
        <div class="container py-3">
            <div class="row g-5">
                ...
                <div class="col-lg-9">
                            ...
                            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="price-tab" data-bs-toggle="tab" href="#price" role="tab"
                                        aria-controls="price" aria-selected="false">Harga Buku</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <a href="{{ url('/front-request') }}" class="btn btn-danger py-2 px-4 mt-3 wow zoomIn"
                        data-wow-delay="0.9s">Kembali</a>

                    {{-- @if ($userAlternative->isNotEmpty())
                        <button type="button" class="btn btn-warning py-2 px-4 ms-2 mt-3 wow zoomIn"
                            data-wow-delay="0.9s" data-bs-toggle="modal" data-bs-target="#listuserModal">
                            Daftar Usulan Pemustaka
                        </button>
                    @endif --}}

                    <button type="button" class="btn btn-success py-2 px-4 ms-2 mt-3 wow zoomIn btn-usulkan"
                        data-wow-delay="0.9s" data-bs-toggle="modal" data-bs-target="#exampleModal"
                        data-bookid="{{ $item->id }}">Usulkan</button>
    ...
    @include('pages.front.request_book.list_user')
    {{-- end modal --}}
@endsection
