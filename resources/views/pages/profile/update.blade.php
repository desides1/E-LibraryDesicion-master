<div class="modal fade" id="userManageModal" tabindex="-1" role="dialog" aria-labelledby="userManageModalTitle"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="" id="formChangePassword" enctype="multipart/form-data" method="post"
                action="{{ route('profile-management.updatePassword') }}">
                @csrf
                <div class="modal-body">
                    <label for="password_new">Kata Sandi Lama: </label>
                    <div class="form-group">
                        <input id="password_old" type="password" placeholder="Masukkan Kata Sandi" class="form-control"
                            autofocus required name="password_old" oninput="validateInput(this)">
                        <span toggle="#password_old" class="fa fa-fw fa-eye field-icon toggle-password"
                            onclick="togglePassword('password_old')"></span>
                    </div>
