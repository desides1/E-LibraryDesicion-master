            ...
            <div class="card-body">
                <form class="form form-horizontal" id="formInsert" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" accept=".jpg, .jpeg, .png" onchange="previewImage()" class="form-control"
                                id="inputImage" value="{{ old('image') }}" name="image" required>
...
@push('scripts')
    ...
    @include('pages.book.dist.image_insert')
@endpush
