        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" id="formUpdate" enctype="multipart/form-data" method="PATCH"
                    action="{{ route('book-collection.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="publication_date" name="publication_date"
                                value="{{ old('publication_date', $data->publication_date) }}" oninput="(() => { restrictNumberPn(this); })()">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="publisher" name="publisher"
                                ...
                                required oninput="(() => { restrictInput(this); })()">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="category" class="col-sm-2 col-form-label">Klasifikasi Buku</label>
                        <div class="col-sm-10">
                            <select class="choices form-select" name="category_id" id="category" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="available_stock"
                                value="{{ old('available_stock', $data->available_stock) }}" name="available_stock"
                                required oninput="(() => { restrictNumber(this); })()">
                        </div>
                    </div>
                    <div class="mb-3 row">
...
@push('scripts')
    ...
    @include('pages.book.dist.image_update')
@endpush
