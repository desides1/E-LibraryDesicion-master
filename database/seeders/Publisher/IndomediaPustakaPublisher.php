...
class IndomediaPustakaPublisher extends Seeder
{
    /**
    ...
    public function run()
    {
        $filePath = database_path('seeders/data/publisher/indomedia_pustaka_book.json');
        $data = $this->readDataFromJson($filePath);

        $publisherName = 'Indomedia Pustaka';
